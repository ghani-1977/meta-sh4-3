...
SRC_URI = "https://sourceforge.net/projects/lirc/files/LIRC/0.9.0/lirc-${PV}.tar.bz2 \
	...
	${@bb.utils.contains("MACHINE", "hl101", "file://lircd.conf.03_00_01 file://lircd.conf.03_00_02 file://lircd.conf.03_00_07 file://lircd_spark.init", "", d)} \
	${@bb.utils.contains_any("MACHINE", "spark spark7162", "file://${PN}_spark.patch file://lircd.conf.09_00_07 file://lircd.conf.09_00_08 file://lircd.conf.09_00_0B file://lircd.conf.09_00_1D file://lircd.conf.09_00_0D file://lircd_spark.init", "file://${PN}_sh4.patch", d)} \
	"
