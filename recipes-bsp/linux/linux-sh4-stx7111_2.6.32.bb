...
COMPATIBLE_MACHINE = "^(hs7110|hs7119|hs7420|hs7429|hs7810a|hs7819|vitamin_hd5000|atemio520|atemio530|adb_2850|opt9600mini|ufs912|spark)$"
...
SRC_URI_append = " \
	...
	${@bb.utils.contains("MACHINE", "spark", "", "file://linux-sh4-lirc_stm_stm24_${STM_PATCH_STR}.patch;patch=1", d)} \
	"
